    ...
    technicalQuestions: [
      {
        ...
        intention: "Assess React state management knowledge.",
        answer:
          "useState is ideal for simple state logic, whereas useReducer is better for complex state transitions.",
      },
      {
        question: "What is the JavaScript Event Loop?",
        intention: "Check asynchronous programming knowledge.",
        answer:
    ...
    behavioralQuestions: [
      {
        ...
        answer:
          "Use STAR format and explain the challenge, approach and result.",
      },
    ],
    ...
    preparationPlan: [
      {
        day: 1,
        focus: "DSA",
        tasks: ["Arrays", "Binary Search", "Trees"],
      },
      {
        day: 2,
        focus: "React",
        tasks: ["Hooks", "Context API", "Performance Optimization"],
      },
    ],
  };
